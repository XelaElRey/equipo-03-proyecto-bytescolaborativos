...
public class JwtAuthorizationFilter extends OncePerRequestFilter {
   ...
   * 3-Si el token es válido, extraemos el nombre de usuario del token y creamos
   * un objeto de autenticación.
   * 4-Establecemos el objeto de autenticación en el contexto de seguridad de
   * Spring
  ...
  /**
   * Método encargado de extraer el token JWT de la cabecera Authorization de la
   * petición HTTP.
