...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    /**
     * Método encargado de cargar los detalle de un usuario por su nombre de usuario.
     ...
     * 3-Si el usuario existe, convierte el objeto User obtenido en un objeto UserDetails.
     * 
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        User userEntity = 
            userRepository
                ...
                .orElseThrow(() -> new UsernameNotFoundException("No se encontrado el usuario con el nombre de usaurio: " + username));
