...
public class TournamentControllerImpl implements TournamentController {
  ...
  public ResponseEntity<List<TournamentResponseDTO>> getTournaments(
    ...
    List<TournamentResponseDTO> tournaments = tournamentService.getTournaments(page, size, sort, status, game, q);
  ...
  public ResponseEntity<TournamentJoinResponseDTO> join(
    ...
    TournamentJoinResponseDTO response = tournamentService.joinTournament(id, username, request);
